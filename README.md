# Thought Process while creating the modal dialog app.

### The Goal:

We want to write a modal component(dialog?) using react. The component will have two states, Opened and closed.  When in opened state the component's backdrop should cover the whole screen along with the dialog area in the middle. 

Clicking on the modal dialog's backdrop should close it. 
